...
half _Surface;
float _Brightness;
float _AdditionalLightSegmentation;
float _FirstShade;
float _FirstShadeTransitionSoftness;
float _SecondShade;
float _SecondShadeTransitionSoftness;
bool _UseColor;
bool _DoHighlights;
float _ColorOffset;
float _DitherScale;
...
// float _AcuteStartDot;
// float _NormalStrength;
// float _NormalTightening;
// float _NormalThreshold;
// float _FarNormalThreshold;
// float _FarNormalStartDepth;
// float _FarNormalEndDepth;
