...
namespace UnityEditor.Rendering.Universal.ShaderGUI
{
    ...
    /// </summary>
    public static class TexelShaderGUI

    {
        ...
        public static class Styles
        {
            ...
            public static GUIContent specularMapText =
                EditorGUIUtility.TrTextContent("Specular Map",
            ...
            public static GUIContent metallicMapText =
                EditorGUIUtility.TrTextContent("Metallic Map",
        ...
        public struct LitProperties
        {
            ...
            public LitProperties(MaterialProperty[] properties)
            {
                ...
                // Surface Input Props
                paletteTex = BaseShaderGUI.FindProperty("_PaletteTex", properties, false);
                targetPaletteTex = BaseShaderGUI.FindProperty("_TargetPaletteTex", properties, false);
                colorOffset = BaseShaderGUI.FindProperty("_ColorOffset", properties, false);
                useColor = BaseShaderGUI.FindProperty("_UseColor", properties, false);
                doHighlights = BaseShaderGUI.FindProperty("_DoHighlights", properties, false);
                additionalLightSegmentation =
                    BaseShaderGUI.FindProperty("_AdditionalLightSegmentation", properties, false);
        ...
        public static void DoClearCoat(LitProperties properties, MaterialEditor materialEditor, Material material)
        {
            ...
            EditorGUI.BeginDisabledGroup(!coatEnabled);
            {
                ...
                materialEditor.TexturePropertySingleLine(Styles.clearCoatMaskText, properties.clearCoatMap,
            ...
            Material material)
        {
            ...
            DoSmoothness(materialEditor, material, properties.smoothness, properties.smoothnessMapChannel,
        ...
        public static void DoSmoothness(MaterialEditor materialEditor, Material material, MaterialProperty smoothness,
            MaterialProperty smoothnessMapChannel, string[] smoothnessChannelNames)
        {
            EditorGUI.indentLevel += 2;
        ...
        public static void PaletteInputs(LitProperties properties, MaterialEditor materialEditor, Material material)
        {
            EditorGUILayout.LabelField("Custom Lighting & Palette", EditorStyles.boldLabel);

            materialEditor.TexturePropertySingleLine(new GUIContent("Source Palette"), properties.paletteTex);
            materialEditor.TexturePropertySingleLine(new GUIContent("Target Palette"), properties.targetPaletteTex);
            materialEditor.ShaderProperty( properties.colorOffset,  properties.colorOffset.displayName);

            materialEditor.ShaderProperty( properties.useColor,  properties.useColor.displayName);
            materialEditor.ShaderProperty( properties.doHighlights,  properties.doHighlights.displayName);
            materialEditor.ShaderProperty( properties.additionalLightSegmentation,  properties.additionalLightSegmentation.displayName);
        }
    }
}
